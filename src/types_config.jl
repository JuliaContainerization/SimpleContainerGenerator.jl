...
@inline function Config(pkg::Union{AbstractDict{<:Symbol, <:AbstractString}, AbstractString, NamedTuple};
                        kwargs...)
    return Config([pkg]; kwargs...)
end

@inline function Config(pkg_names::AbstractVector{<:AbstractString};
                        kwargs...)
...
@inline function Config(pkg_tuples::AbstractVector{<:NamedTuple};
                        kwargs...)
